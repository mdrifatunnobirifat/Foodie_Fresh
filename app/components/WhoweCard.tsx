...
{
    return (
    <div className="flex items-center bg-[#e5fae9] hover:bg-[#23803a]  p-0.5 md:p-3 rounded-xl cursor-pointer transition-all group w-full">
      ...
      <div className=" flex-1">
        <h3 className=" text:xs md:text-md font-bold text-emerald-950 group-hover:text-white">{h}</h3>
        <p className="text-xs group-hover:text-white/80">{p}</p>
      </div>
