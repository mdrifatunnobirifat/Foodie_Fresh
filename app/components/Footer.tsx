    ...
    <div className="text-center py-5  bg-emerald-950">
      ...
      <div className="flex flex-col md:flex-row w-full  justify-evenly  text-center md:text-left  ">
             ...
             <h1 className="lg:text-3xl text-2xl  text-white font-bold font-sans" >Foodie Fresh</h1>
              ...
              <br></br>
                ...
                <div className="flex flex-row gap-2">
                    ...
                    <Image src="twitter-svgrepo-com.svg" alt="facebook" width={27} height={30} 
                    className="object-contain inline-block filter invert " />
                    <Image src="instagram-svgrepo-com.svg" alt="facebook" width={35} height={30} 
                    className="object-contain inline-block  filter invert" />
                </div>
        ...
        <div className=" text-neutral-300   font-sans">
           ...
           <ul className=" text-sm list-none space-y-2">
             <li className="flex flex-row gap-2"><Image src="/map-pin-alt-svgrepo-com.svg" alt="map icon" width={23} height={23}
                className="object-contain  inline-block invert"/>
              <span>Linsedt,23/234, London ,Dhaka</span>
             </li>
             <li className="flex flex-row gap-2"><Image src="/phone-svgrepo-com.svg" alt="map icon" width={23} height={23}
                className="object-contain  inline-block invert"/>
              <span>010101010101</span>
             </li>
             <li className="flex flex-row gap-2"><Image src="/mail-svgrepo-com.svg" alt="map icon" width={23} height={23}
                className="object-contain  inline-block invert"/>
              <span>Linsedt@gmail.com</span>
             </li>
             <li className="flex flex-row gap-2"><Image src="/clock-square-svgrepo-com.svg" alt="map icon" width={23} height={23}
                className="object-contain  inline-block invert"/>
        ...
        <div className="flex flex-col">
            ...
            <div className="flex flex-row w-full justify-baseline   px-20 gap-5">
                 <Image src="/visa-svgrepo-com.svg" alt="playstore" width={50} height={50}
                   className="object-contain"/>
                 <Image src="/mastercard-svgrepo-com.svg" alt="playstore" width={50} height={50}
                    className="object-contain"/>
                  <Image src="/american-express-svgrepo-com.svg" alt="playstore" width={50} height={50}
                    className="object-contain"/>
