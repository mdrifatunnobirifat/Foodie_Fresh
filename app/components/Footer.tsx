      ...
      <div className="flex flex-col md:flex-row w-full  justify-evenly   text-center md:text-left  gap-3  ">
        ...
        <div className=" text-neutral-300    font-sans">
           ...
           <ul className=" text-sm list-none  space-y-2">
             ...
             <li className="flex flex-row  gap-2 justify-center md:justify-start  "><Image src="/phone-svgrepo-com.svg" alt="map icon" width={23} height={23}
                className="object-contain  inline-block invert"/>
              <span>010101010101</span>
             </li>
             <li className="flex flex-row  gap-2 justify-center md:justify-start "><Image src="/mail-svgrepo-com.svg" alt="map icon" width={23} height={23}
                className="object-contain  inline-block invert"/>
              <span>Linsedt@gmail.com</span>
             </li>
             <li className="flex flex-row  gap-2 justify-center md:justify-start"><Image src="/clock-square-svgrepo-com.svg" alt="map icon" width={23} height={23}
                className="object-contain  inline-block invert"/>
